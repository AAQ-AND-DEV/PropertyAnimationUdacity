...
class MainActivity : AppCompatActivity() {
    ...
    private fun ObjectAnimator.changeEnabledOnAnimate(view : View){
    ...
    private fun rotater() {
        ...
        animator.changeEnabledOnAnimate(rotateButton)
        animator.start()
    }
    ...
    private fun translater() {
        ...
        animator.changeEnabledOnAnimate(translateButton)
        animator.start()
    }
    ...
    private fun colorizer() {
        //ofArgb introduced in API 21, can use TypeEvaluator (ArgbEvalutator) for early sdk
        val animator = ObjectAnimator.ofArgb(star.parent, "backgroundColor",
        Color.BLACK, Color.RED)
        animator.repeatCount = 1
        animator.repeatMode = ObjectAnimator.REVERSE
        animator.duration = 1000
        animator.changeEnabledOnAnimate(colorizeButton)
        animator.start()
